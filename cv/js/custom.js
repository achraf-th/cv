(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        function init() {
            var mapOptions = {
                zoom: 9,
                center: new google.maps.LatLng(48.9361367, 2.3662473),
        ...
        $('form#contact-form').on('submit', function (e) {
            ...
            $.ajax({
                ...
                .done(function () {
                    ...
                    Materialize.toast('Message envoyé ! vous aurez une réponse prochainement, merci.', 4000);
                ...
                .fail(function () {
                    $('div#form-loader').fadeOut(500);
                    Materialize.toast('Désolé, message non envoyé !', 4000);
                    $("#submit").removeAttr('disabled', 'disabled'); // Enable submit button
                });
        });
